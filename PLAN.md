...
| M3 | **Click-through overlay + item model + results panel** (in progress): `Session` model, resolver stub, inference worker, results panel, and an eframe/glow overlay; Wayland layer-shell keyboard/click-through + the platform resolver land in M4 (ADR-30) |
