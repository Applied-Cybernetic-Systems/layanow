...
//!
//! ```sh
//! printf 'layanow primary probe' | wl-copy -p
//! cargo run -p layanow-platform --example read_primary
//! wl-copy -c -p
//! ```
...
fn main() {
    let resolver: Box<dyn TextResolver> = layanow_platform::selection::resolver();
