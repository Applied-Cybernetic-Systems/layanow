...
//! ```
//!
//! `LAYANOW_CHECKPOINT` selects the checkpoint (default `english`) and
//! `LAYANOW_QUANT` the precision (`fp32`/`fp16`/`int8`). The bundle is
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Q: {question}  [{:?} · {}]", variant.quant, spec.id);
